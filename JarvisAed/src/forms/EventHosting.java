...
public class EventHosting extends javax.swing.JFrame {
    ...
    public ArrayList<Events_hosted> eventList() {
        ...
        try {
           ...
           // prep1.setString(3,jTextField2.getText());
            ...
            while (rs.next()) {
                events = new Events_hosted(rs.getString("EventId"), rs.getString("EventName"), rs.getString("Organizer"), rs.getString("Address"), rs.getString("Food"), rs.getInt("Available_Ticket"));
    ...
    private void initComponents() {
        ...
        searchButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/forms/icons/magnifying-glass.png"))); // NOI18N
