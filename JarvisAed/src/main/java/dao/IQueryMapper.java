...
// "SELECT * FROM EVENTS WHERE Role = ?";
    ...
    public String SELECT_REVIEWED_EVENTS_2 = "SELECT EVENTID, EVENTNAME, PROPERTYNAME, LOCATION, EVENTTYPE, HOSTEDBY, EVENTADMIN, DATEON FROM REVIEWED_EVENTS WHERE EVENTADMIN = ? AND EVENTTYPE IN (?,?,?,?,?)";
